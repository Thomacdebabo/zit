...
def show_awake_intervals(date, all):
    ...
    def process_events(events):
        ...
        for event in events:
            ...
            elif event.event_type in [SystemEventType.SLEEP, SystemEventType.SHUTDOWN] and current_start is not None:
    ...
    def print_intervals(intervals, date_str):
        ...
        for start, end in intervals:
            ...
            print_string(f"  {start.strftime('%H:%M:%S')} - {end.strftime('%H:%M:%S')} "
